...
python mot_to_xml.py root_dir=/data/MNIST_MOT_RGB_512x512_3_1000_9600_var img_dir=Images list_file_name=lists/ctc_train.txt data_type=annotations mode=1 ignore_invalid=0 start_id=0 label=cell show_img=1 vis_size=1920x1080 sample=30 save_img_seq=1
